...
<template>
    <div class="flex flex-col items-start gap-2">
        ...
        <div class="flex flex-row items-center justify-between w-full">
            <h2 class="font-bold md:text-xl lg:text-2xl">{{oop ? "OOP" : "IP"}} Range</h2>
            <span 
        ...
        <table class="table-fixed">
            <tbody>
                <tr v-for="row in 13" :key="row" class="h-4 2xl:h-5">
                    <td v-for="col in 13" :key="col" class="relative w-4 2xl:w-5 px-0 py-0 border-[0.5px] border-neutral-content">
